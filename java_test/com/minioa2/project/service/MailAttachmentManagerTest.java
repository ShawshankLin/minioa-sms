...
public class MailAttachmentManagerTest extends BaseManagerTestCase{

	private MailAttachmentManager manager;
	...
	public void crud() {
		...
		MailAttachment obj = newMailAttachment();
		manager.save(obj);
	...
	public static MailAttachment newMailAttachment() {
		MailAttachment obj = new MailAttachment();
	  	...
	  	obj.setFiletype(new java.lang.String("1"));
	  	obj.setFilesize(new java.lang.Integer("1"));
	  	obj.setOldname(new java.lang.String("1"));
		return obj;
	}
}
