...
<ul class="nav nav-inline admin-nav">
	<li class="active">
	 <ul>
		 <li class="active"><a href="${ctx}/pages/NoteReceive/getNoseeNote.do" target="noteRightFrame">未确认短信</a></li>
		 <li><a href="${ctx}/pages/NoteSend/newNote.do" target="noteRightFrame">发送内部短信</a></li>
