...
<ul class="nav nav-inline admin-nav">
	<li class="active">
	 <ul>
		 <li class="active"><a href="${ctx}/pages/User/list.do" target="sysRightFrame">用户管理</a></li>
		 <li><a href="${ctx}/pages/Role/list.do" target="sysRightFrame">角色管理</a></li>
		 <li><a href="${ctx}/pages/Log/list.do" target="sysRightFrame">系统日志</a></li>
	 </ul>
	</li>
</ul>
