		...
		<fieldset>
			...
			<table>
				<tr>	
					...
					<td>
							<input type="text" value="${query.cidModelTag}" id="cidModelTag" name="cidModelTag"/>
					</td>
					...
					<td>
							<input type="text" value="${query.midModelTag}" id="midModelTag" name="midModelTag"/>
					</td>
		...
		<table width="100%"  border="0" cellspacing="0" class="tablelist">
		  ...
		  <tbody>
			  ...
			  <tr class="${status.count % 2 == 0 ? 'odd' : 'even'}">
				...
				<td><c:out value='${item.midModel.modelTagValue}'/>&nbsp;</td>
