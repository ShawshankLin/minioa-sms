...
@Entity
@Table(name = "note_send")
public class NoteSend extends BaseEntity implements java.io.Serializable{
	...
	@Column(name = "sendid", unique = false, nullable = true, insertable = true, updatable = true, length = 65535)
	...
	@OneToMany(cascade = { CascadeType.MERGE }, fetch = FetchType.LAZY, mappedBy = "fromidModel")
	...
	public boolean equals(Object obj) {
		if(obj instanceof NoteSend == false) return false;
		if(this == obj) return true;
		NoteSend other = (NoteSend)obj;
